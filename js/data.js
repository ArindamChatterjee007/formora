...
const FOOD_DB = [
  ...
  { keys: ["chicken", "chicken breast", "grilled chicken", "chicken curry"], kcal: 250, protein: 46, unit: "serving" },
  ...
  { keys: ["protein shake", "protine shake", "whey protein", "whey", "protein powder", "protine", "scoop"], kcal: 120, protein: 24, unit: "scoop" },
  ...
  // --- drinks ---
  { keys: ["lassi", "mango lassi", "sweet lassi"], kcal: 180, protein: 6, unit: "glass" },
  { keys: ["buttermilk", "chaas", "chhas", "chaach", "mattha"], kcal: 40, protein: 3, unit: "glass" },
  { keys: ["banana shake", "milkshake", "milk shake", "smoothie", "fruit shake"], kcal: 220, protein: 8, unit: "glass" },
  { keys: ["orange juice", "mosambi juice", "fruit juice", "juice"], kcal: 110, protein: 1, unit: "glass" },
  { keys: ["coconut water", "nariyal pani", "tender coconut"], kcal: 45, protein: 2, unit: "glass" },
  { keys: ["cola", "coke", "pepsi", "soft drink", "soda", "energy drink"], kcal: 140, protein: 0, unit: "can" },
  { keys: ["beer"], kcal: 150, protein: 1, unit: "glass" },
  { keys: ["wine"], kcal: 125, protein: 0, unit: "glass" },
  { keys: ["water"], kcal: 0, protein: 0, unit: "glass" },
  // --- rice / grains ---
  { keys: ["khichdi", "khichri"], kcal: 250, protein: 8, unit: "bowl" },
  { keys: ["veg pulao", "pulao", "pilaf", "jeera rice"], kcal: 330, protein: 7, unit: "plate" },
  { keys: ["curd rice", "dahi rice"], kcal: 280, protein: 8, unit: "bowl" },
  { keys: ["lemon rice", "tamarind rice"], kcal: 300, protein: 6, unit: "plate" },
  // --- breads ---
  { keys: ["poori", "puri", "luchi"], kcal: 100, protein: 2, unit: "piece" },
  { keys: ["bhatura", "bhature"], kcal: 250, protein: 5, unit: "piece" },
  { keys: ["thepla", "methi thepla"], kcal: 150, protein: 4, unit: "piece" },
  { keys: ["aloo paratha"], kcal: 300, protein: 6, unit: "piece" },
  // --- curries / mains ---
  { keys: ["dal makhani"], kcal: 300, protein: 12, unit: "bowl" },
  { keys: ["kadhi"], kcal: 180, protein: 6, unit: "bowl" },
  { keys: ["sambar"], kcal: 120, protein: 6, unit: "bowl" },
  { keys: ["rasam"], kcal: 60, protein: 3, unit: "bowl" },
  { keys: ["palak paneer", "saag paneer"], kcal: 250, protein: 14, unit: "bowl" },
  { keys: ["egg curry", "anda curry"], kcal: 220, protein: 13, unit: "bowl" },
  { keys: ["keema", "kheema"], kcal: 280, protein: 20, unit: "bowl" },
  { keys: ["butter chicken", "chicken tikka masala"], kcal: 380, protein: 30, unit: "bowl" },
  { keys: ["chicken tikka", "tandoori chicken"], kcal: 250, protein: 30, unit: "serving" },
  { keys: ["seekh kebab", "kebab", "kabab"], kcal: 130, protein: 10, unit: "piece" },
  { keys: ["fish fry", "fried fish"], kcal: 220, protein: 18, unit: "piece" },
  { keys: ["fish curry"], kcal: 250, protein: 22, unit: "bowl" },
  // --- snacks / street food ---
  { keys: ["momo", "momos", "dumpling", "dumplings"], kcal: 40, protein: 2, unit: "piece" },
  { keys: ["spring roll", "spring rolls"], kcal: 120, protein: 3, unit: "piece" },
  { keys: ["vada pav"], kcal: 290, protein: 6, unit: "piece" },
  { keys: ["pav bhaji"], kcal: 400, protein: 9, unit: "plate" },
  { keys: ["misal pav", "misal"], kcal: 350, protein: 12, unit: "plate" },
  { keys: ["dhokla"], kcal: 150, protein: 5, unit: "serving" },
  { keys: ["bhelpuri", "bhel", "sev puri", "chaat"], kcal: 250, protein: 5, unit: "plate" },
  { keys: ["pani puri", "golgappa", "puchka", "gol gappa"], kcal: 150, protein: 3, unit: "plate" },
  { keys: ["kachori"], kcal: 180, protein: 4, unit: "piece" },
  { keys: ["uttapam", "uttapa"], kcal: 200, protein: 5, unit: "piece" },
  { keys: ["kathi roll", "frankie", "wrap", "shawarma"], kcal: 350, protein: 15, unit: "piece" },
  { keys: ["french fries", "fries", "finger chips"], kcal: 320, protein: 4, unit: "serving" },
  { keys: ["chips", "wafers"], kcal: 150, protein: 2, unit: "pack" },
  { keys: ["popcorn"], kcal: 120, protein: 3, unit: "bowl" },
  // --- breakfast / high-protein ---
  { keys: ["cornflakes", "cereal", "muesli"], kcal: 180, protein: 6, unit: "bowl" },
  { keys: ["pancake", "pancakes"], kcal: 150, protein: 4, unit: "piece" },
  { keys: ["besan chilla", "moong chilla", "cheela", "chilla"], kcal: 150, protein: 8, unit: "piece" },
  { keys: ["sprouts", "moong sprouts"], kcal: 120, protein: 8, unit: "bowl" },
  { keys: ["makhana", "fox nuts"], kcal: 100, protein: 3, unit: "bowl" },
  { keys: ["sweet corn", "corn", "bhutta"], kcal: 130, protein: 4, unit: "bowl" },
  { keys: ["soup"], kcal: 120, protein: 5, unit: "bowl" },
  { keys: ["canned tuna", "tuna can"], kcal: 120, protein: 26, unit: "can" },
  // --- sweets / desserts ---
  { keys: ["kheer", "payasam", "phirni"], kcal: 200, protein: 5, unit: "bowl" },
  { keys: ["halwa"], kcal: 250, protein: 4, unit: "bowl" },
  { keys: ["jalebi"], kcal: 150, protein: 1, unit: "piece" },
  { keys: ["laddu", "ladoo"], kcal: 180, protein: 3, unit: "piece" },
  { keys: ["barfi", "burfi"], kcal: 150, protein: 3, unit: "piece" },
  { keys: ["cake", "pastry"], kcal: 250, protein: 3, unit: "slice" },
  { keys: ["donut", "doughnut"], kcal: 250, protein: 4, unit: "piece" },
  // --- nuts / spreads / fruit ---
  { keys: ["cashew", "kaju"], kcal: 55, protein: 2, unit: "handful" },
  { keys: ["walnut", "akhrot"], kcal: 65, protein: 2, unit: "handful" },
  { keys: ["dates", "khajur"], kcal: 20, protein: 0, unit: "piece" },
  { keys: ["raisins", "kishmish"], kcal: 30, protein: 0, unit: "handful" },
  { keys: ["honey", "shahad"], kcal: 64, protein: 0, unit: "tbsp" },
  { keys: ["jam"], kcal: 55, protein: 0, unit: "tbsp" },
  { keys: ["grapes", "angoor"], kcal: 90, protein: 1, unit: "bowl" },
  { keys: ["watermelon", "papaya", "guava"], kcal: 80, protein: 1, unit: "bowl" },
  { keys: ["pomegranate", "anar"], kcal: 105, protein: 2, unit: "bowl" },
  { keys: ["thali", "meal plate"], kcal: 700, protein: 25, unit: "plate" },
];
