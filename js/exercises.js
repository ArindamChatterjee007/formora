  ...
  _renderGrid() {
    ...
    el.innerHTML = shown.map((e) => `
      <button class="exp-card" onclick="Exercises.pick('${e.id}')">
        <span class="exp-thumb">${this.imgFor(e) ? `<img src="${this.imgFor(e)}" alt="${esc(e.name)}" loading="lazy" onerror="this.style.display='none';this.parentElement.classList.add('noimg')">` : ""}</span>
